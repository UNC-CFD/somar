...
#include "MappedLevelFluxRegisterF_F.H"
...
bool MappedLevelFluxRegister::s_verbose = false;
void
MappedLevelFluxRegister::poutCoarseRegisters() const
{
...
bool MappedLevelFluxRegister::hasCF(const DataIndex& a_fineDataIndex, Side::LoHiSide) const
{
...
bool MappedLevelFluxRegister:: hasCF(const DataIndex& a_coarseIndex) const
{
    // return m_coarFlux.isDefined();
    // Has CF if everything defined
    return isAllDefined();
...
MappedLevelFluxRegister::MappedLevelFluxRegister()
    :
    m_isDefined(FluxRegUndefined),
...
bool
MappedLevelFluxRegister::isDefined() const
{
    return (m_isDefined & FluxRegDefined);
}

bool
MappedLevelFluxRegister::isAllDefined() const
{
...
void
MappedLevelFluxRegister::undefine()
{
    m_isDefined = FluxRegUndefined;
}
...
void MappedLevelFluxRegister::reflux (LevelData<FArrayBox>& a_levelDiv,
                                      ...
                                      const Real            a_scale)
{
    this->reflux(a_levelDiv, a_crseLevGeo.getCCJinv(), a_scale);
}
...
// // -----------------------------------------------------------------------------
// void
// MappedLevelFluxRegister::reflux(LevelData<FArrayBox>& a_uCoarse,
//                           Real a_scale)
// {
...
// // -----------------------------------------------------------------------------
// // -----------------------------------------------------------------------------
// void MappedLevelFluxRegister::reflux(LevelData<FArrayBox>& a_uCoarse,
...
// -----------------------------------------------------------------------------
// -----------------------------------------------------------------------------
void MappedLevelFluxRegister::reflux(
    ...
    Real                  a_scale )
{
    ...
    CH_TIME("MappedLevelFluxRegister::reflux");
