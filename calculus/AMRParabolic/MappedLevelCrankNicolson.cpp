...
// Full constructor
// -----------------------------------------------------------------------------
MappedLevelCrankNicolson::MappedLevelCrankNicolson (const Vector<DisjointBoxLayout>&                                 a_grids,
...
// Destructor
// -----------------------------------------------------------------------------
MappedLevelCrankNicolson::~MappedLevelCrankNicolson ()
{;}
...
// -----------------------------------------------------------------------------
void MappedLevelCrankNicolson::updateSoln (LevelDataType&           a_phiNew,
                                           ...
                                           int                      a_fluxStartComponent)
{
    ...
    this->incrementFlux(a_flux, a_phiNew,       a_level, 0.5, a_dt, -1.0, true); // Changed from false by ES
