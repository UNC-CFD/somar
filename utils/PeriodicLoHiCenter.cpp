                         ...
                         const int&           a_dir)
{
    ...
    Box perDomBox = a_domain.domainBox();
    for (int dir = 0; dir < SpaceDim; ++dir) {
        if (a_domain.isPeriodic(dir)) {
            perDomBox.grow(dir, 4);
        }
    }
...
void PeriodicLoHiCenterFace4 (Box&                 a_loBox,
                              ...
                              const int&           a_dir)
{
    PeriodicLoHiCenterFace(a_loBox, a_hasLo, a_hiBox, a_hasHi,
...
void PeriodicLoHiCenter5 (Box&                 a_loBox,
                          ...
                          const int&           a_dir)
{
    PeriodicLoHiCenter(a_loBox, a_hasLo, a_hiBox, a_hasHi,
                       a_centerBox, a_entireBox, a_inBox, a_domain, a_dir);
    a_innerCenterBox = a_centerBox;
    if (a_hasLo) {
        a_nextLoBox = a_loBox;
